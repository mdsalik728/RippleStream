...
export  async function signup(req,res){
    ...
    if(existingUser){
        return res.status(400).json({message: "Email already exist , enter a different Email"});

    }
    const index=Math.floor(Math.random()*100)+1;  //generate a number from 1 to 100
